...
При обнаружении тишины (3 секунды звук был тише порога в -60 dBFS) запись останавливается и возобновляется через 1 секунду после устойчивого появления звука выше порога. Есть возможность не останавливать запись при обнаружении тишины.
